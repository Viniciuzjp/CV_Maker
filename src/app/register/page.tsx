    ...
    return (
        ...
        <div className="h-screen w-screen flex justify-center items-center">
            ...
            <p className="text-gray-500 text-sm">{data.email}</p>
                ...
                <label className="text-gray-500 mb-1" htmlFor="username">Username</label>
                <input
                onFocus={handleStyle}
                ...
                <div className="flex flex-col">
                <label className="text-gray-500 mb-1" htmlFor="password2">Confirm Password</label>
                <input
                onChange={handleSetData}
                id="password2"
                type="password"
                ...
                <button onClick={handleSubmit} className="h-10 w-100 bg-blue-400 text-white rounded-md">Register</button>
            </div>
        </div>
        </>
    );
